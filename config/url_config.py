...
class URLConf(enum.Enum):
    ...
    #  此处连接配置到脚本中，微信支付的url 不需要网关的 ，这里的网关都可以关系了 ，以下连个都直接配置到程序中了
    # url = "https://openapi-cn-test.xiaoyi.com/orderpay/v8/wx/pay/callback"  # 直接调用微信的，不走网关
    # url = "https://open-gw.xiaoyi.com/orderpay/v8/wx/pay/callback"  # 直接调用微信的，不走网关
